...
\item
  ...
  \item
    ...
    \item
      ...
      and Frederick Solt. 2026. ``Macrodiscontent Across Countries''
      \emph{Accepted at European Political Science Review}
    \end{enumerate}
  \item
    \begin{enumerate}
    \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \item
    ...
    ``Can We Trust LLM-Generated Data? The CRAFT Framework for
    Measurement and Inference in Political Science'' {[}\textbf{Co--lead
    Author}{]} {[}\textbf{Under Review}{]}
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      ``When F1 Lies: Taking Constructs Seriously in AI-Assisted
      Measurement'' (Qunhua Li)
    \end{enumerate}
  \item
    \begin{enumerate}
    \def\labelenumi{\arabic{enumi}.}
